...
// на конкретном AnimNotifyState_Hitbox (`Animation Setup.md`). Одновременно может быть открыто
...
// переходе «были зоны -> зон не осталось» (`Animation Setup.md`).
...
public:
	...
	/** (`Parrying.md`): кратковременно замедляет текущий проигрываемый монтаж
