...
//
// Модель (`Parrying.md`): окно парирования размечается на монтаже защищающегося
...
public:
	 ...
	 *  (`Parrying.md`). Сбрасывается ActivateStep перед новым своим шагом. */
...
private:
	 ...
	 *  (открытый вопрос, там же про смену оружия). */
