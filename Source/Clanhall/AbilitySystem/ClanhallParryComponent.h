...
public:
	...
	/** Единственная точка входа для КОРМИЛЬЦЕВ шкалы Stagger (task_stagger_control_code.md §1) —
...
private:
	 ...
	 *  main_dev_plan.md, Раздел 8, «Открытые вопросы», п.18 (там же про смену оружия). */
