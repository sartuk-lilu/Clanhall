...
// WASD-ударов основной путь — резолв по контакту зоны (main_dev_plan.md §7).
...
protected:
	/** Раздел 2-3: мгновенный поиск цели сферой перед персонажем. Уже не основной путь урона
	 *  у WASD-ударов (тот резолвится по контакту зоны, см.
