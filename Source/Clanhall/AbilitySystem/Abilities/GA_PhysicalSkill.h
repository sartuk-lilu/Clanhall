...
//
// Порция E2 — два режима резолва, выбираются на активации по Data->CastMontage (см.
...
//     FindMeleeTarget на активации, как до Порции E2. Все четыре ассета Knight сейчас идут
//     этим путём — разметка зон на монтажах ещё не сделана (редакторная работа, не код).
//
...
// следующей способности (Порция D); (2) активка — CancelSequenceForExternalMontage() гасит
