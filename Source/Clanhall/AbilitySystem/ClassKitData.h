// Класс бойца одним ассетом. Раньше ComboData,
...
// (смена класса/оружия в рантайме; экран выбора класса), а раньше будет угадан.
...
public:
	 ...
	 *  слотов, `ability_system.md`, «Контрнавык»), а не имя скилла: слот один и тот же для всех оружий,
